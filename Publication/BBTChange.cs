...
{
    public partial class BBTChange : Form
    {
        private String V = "";
        ...
        public BBTChange(String s)
        {
            ...
            // FROM BBT
            dt = new DataTable();
            String SelectBBTQuery = "select * from bientapvien where NHAKHOAHOC_ID = '" + s + "'";
            using (SqlConnection con = new SqlConnection(myConn))
            {
                con.Open();
            ...
            txtMailCo.Text = dt.Rows[0][0].ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand sqlCmd = new SqlCommand("Capnhatprofile_BBT", sqlCon);
